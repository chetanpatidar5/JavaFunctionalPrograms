...
REPLACE INTO `user` (`user_id`, `active`, `email`, `fist_name`, `last_name`, `password`, `user_name`, `pos_id`, `role_id`) VALUES
(1, 1, 'admin@gmail.com', 'Admin', 'Admin', '$2a$10$zswmPMTPQx/haoyigz5z0uGCG37QjBHurv7LRMuEUnTUfVLgUXSu6', 'admin', 3, 1);
(2, 2, 'user@gmail.com', 'User', 'User', '$2a$10$zswmPMTPQx/haoyigz5z0uGCG37QjBHurv7LRMuEUnTUfVLgUXSu6', 'user', 2, 2);
